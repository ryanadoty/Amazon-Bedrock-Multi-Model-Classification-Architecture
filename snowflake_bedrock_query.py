...
def load_samples():
    ...
    :return: The sql samples in from the data/moma_examples.yaml file
    """
    # instantiating the sql samples variable
    sql_samples = None
    # opening our prompt sample file
    with open("data/moma_examples.yaml", "r") as stream:
...
def load_few_shot_chain(llm, db, examples):
    ...
    """
    # This is formatting the prompts that are retrieved from the data/moma_examples.yaml
